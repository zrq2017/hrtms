...
<div class="mainbody">
    ...
    <div class="rig_link">
        <ul>
            <li><a href="#"><img src="<%=path%>/images/img_01.jpg" alt="" title=""></a></li>
            <li><a href="#"><img src="<%=path%>/images/img_02.jpg" alt="" title=""></a></li>
            <li><a href="#"><img src="<%=path%>/images/img_03.jpg" alt="" title=""></a></li>
            <li><a href="#"><img src="<%=path%>/images/img_04.jpg" alt="" title=""></a></li>
        </ul>
    </div>
    <div class="rig_lm01">
        <div class="title"><img src="<%=path%>/images/listicon.jpg" class="icon" style="padding-top:13px;">
            <h2>通知</h2>
            <span class="red_numb">2</span></div>
        <div class="detail">
            <div class="dat01"> <span class="datti"><span>20</span> <br />
              <span class="jan">jan</span></span> <span class="sqdeta"><img src="<%=path%>/images/bs_03.jpg"> 您想王晓磊提交的换班申请已经通过，交换班次时间为2014-02-09  09:00-18:00，请按时上班！</span>
                <p class="linkbut"><a href="#">加入日历</a><a href="#">查看</a><a href="#">知道了</a></p>
            </div>
            <div class="dat02"> <span class="datti"><span>20</span> <br />
              <span class="jan">jan</span></span> <span class="sqdeta"><img src="<%=path%>/images/bs_04.jpg"> 您提交的请假申请未审批通过</span>
    ...
    <div class="rig_lm02">
        ...
        <div class="detail">
            <div class="det_inner">
                <div class="jd"><img src="<%=path%>/images/jd.jpg" alt="" title=""></div>
                <div class="bs">
                    <p><img src="<%=path%>/images/bs_01.jpg" alt="" title=""> 已完成打分</p>
                    <p><img src="<%=path%>/images/bs_02.jpg" alt="" title=""> 未完成打分和异常打分</p>
                </div>
                <div class="scordeti">
                    <ul>
                        <li>
                ...
                <div id="tabCot_product" class="zhutitab">
                    <div class="tabContainer">
                        ...
                        <p class="shent"><span>Show entries: </span>
                            ...
                            <img src="<%=path%>/images/sz.jpg" class="icon" style=""></p>
                        <div class="clear"></div>
                    </div>
                    <div id="tabCot_product_1" class="tabCot" >
                        <table class="tabindex" width="100%" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td bgcolor="#FFFFFF"><div align="center"><img src="<%=path%>/images/tx.jpg"></div></td>
                            ...
                            <tr>
                                <td bgcolor="#f8f8f8"><div align="center"><img src="<%=path%>/images/tx.jpg"></div></td>
                    ...
                    <script language="JavaScript" type="text/javascript" src="<%=path%>/js/tab.js"></script>
                </div>
            </div>
        </div>
    </div>
